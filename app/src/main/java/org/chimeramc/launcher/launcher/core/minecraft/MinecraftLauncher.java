...
public class MinecraftLauncher {
    ...
    public static final String EXTRA_GAME_VERSION = "org.chimeramc.launcher.extra.GAME_VERSION";
    public static final String EXTRA_STORAGE_PROFILE_ID = "org.chimeramc.launcher.extra.STORAGE_PROFILE_ID";
    public static final String EXTRA_STORAGE_FILES_DIR = "org.chimeramc.launcher.extra.STORAGE_FILES_DIR";
    public static final String EXTRA_STORAGE_EXTERNAL_FILES_DIR = "org.chimeramc.launcher.extra.STORAGE_EXTERNAL_FILES_DIR";
    public static final String EXTRA_STORAGE_DATA_DIR = "org.chimeramc.launcher.extra.STORAGE_DATA_DIR";
    public static final String EXTRA_STORAGE_CACHE_DIR = "org.chimeramc.launcher.extra.STORAGE_CACHE_DIR";
    ...
    public void launch(Intent sourceIntent, GameVersion version, LaunchCallback callback) {
        ...
        try {
                    ...
                    if (parts.length >= 2) {
                        ...
                        if (major < 1 || (major == 1 && minor < 21) || (major == 1 && minor == 21 && patch < 80)) {
                            activity.runOnUiThread(() -> {
                                new org.chimeramc.launcher.ui.dialogs.CustomAlertDialog(activity)
                                        .setTitleText(activity.getString(org.chimeramc.launcher.R.string.unsupported_version_title))
                                        .setMessage(activity.getString(org.chimeramc.launcher.R.string.unsupported_version_msg))
                                        .setPositiveButton(activity.getString(org.chimeramc.launcher.R.string.back), null)
                                        .show();
                            });
            ...
            if (version.needsRepair) {
                activity.runOnUiThread(() ->
                        org.chimeramc.launcher.core.versions.VersionManager.attemptRepairLibs(activity, version)
                );
