...
import org.chimeramc.launcher.ui.adapter.AccountsAdapter;
...
public class AccountsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter.setOnAccountActionListener(new AccountsAdapter.OnAccountActionListener() {
            ...
            public void onSetActive(MsftAccountStore.MsftAccount account) {
                ...
                if (withinSevenDays) {
                    runOnUiThread(() -> {
                        org.chimeramc.launcher.util.DialogUtils.dismissQuietly(loadingDialog);
                ...
                loadingDialog = org.chimeramc.launcher.util.DialogUtils.ensure(AccountsActivity.this, loadingDialog);
                org.chimeramc.launcher.util.DialogUtils.showWithMessage(loadingDialog, getString(R.string.ms_login_auth_xbox_device));
            ...
            public void onDelete(MsftAccountStore.MsftAccount account) {
                new org.chimeramc.launcher.ui.dialogs.CustomAlertDialog(AccountsActivity.this)
    ...
    private void refreshUI() {
        boolean enabled = org.chimeramc.launcher.settings.FeatureSettings.getInstance().isLauncherManagedMcLoginEnabled();
