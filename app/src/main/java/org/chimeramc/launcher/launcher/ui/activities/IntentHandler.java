...
import org.chimeramc.launcher.core.minecraft.MinecraftActivity;
import org.chimeramc.launcher.core.minecraft.MinecraftActivityState;
import org.chimeramc.launcher.core.minecraft.MinecraftImportIntents;
import org.chimeramc.launcher.util.InstanceBackupManager;
    ...
    private void handleDeepLink(Intent originalIntent) {
        ...
        if (isMinecraftActivityRunning()) {
            ...
            if (isMcRunning()) {
                ...
                newIntent.setClassName(this, "org.chimeramc.launcher.ui.activities.MainActivity");
            }
        }
