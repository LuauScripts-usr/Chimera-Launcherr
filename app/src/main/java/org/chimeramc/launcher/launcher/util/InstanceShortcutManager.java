...
public final class InstanceShortcutManager {
    public static final String ACTION_LAUNCH_INSTANCE = "org.chimeramc.launcher.action.LAUNCH_INSTANCE_SHORTCUT";
    public static final String EXTRA_INSTANCE_TYPE = "org.chimeramc.launcher.extra.SHORTCUT_INSTANCE_TYPE";
    public static final String EXTRA_INSTANCE_KEY = "org.chimeramc.launcher.extra.SHORTCUT_INSTANCE_KEY";
