...
import org.chimeramc.launcher.core.curseforge.models.ContentFile;
...
public class ContentDetailsActivity extends BaseActivity {
    ...
    private void loadAllFiles() {
        ...
        client.getModFiles(content.id, 0, 50, new CurseForgeClient.CurseForgeCallback<>() {
            @Override
            public void onSuccess(org.chimeramc.launcher.core.curseforge.models.ModFilesResponse result) {
                runOnUiThread(() -> {
    ...
    private void showFilesDialog(java.util.List<ContentFile> files) {
        ...
        org.chimeramc.launcher.ui.adapter.FileListAdapter adapter = new org.chimeramc.launcher.ui.adapter.FileListAdapter(file -> {
            dialog.dismiss();
